      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <FadeInUp delay={0.25}>
          <div className="flex flex-wrap gap-2 sm:gap-3 justify-center items-center mt-6 px-2">
            ...
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-full border border-green-400/50 bg-green-500/10 backdrop-blur-sm">
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
              <span className="text-xs sm:text-sm font-medium text-green-300 tracking-wide">
