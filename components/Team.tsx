        ...
        <div className="mt-16 flex justify-center">
          <div className="w-full max-w-md">
            {t.members.map((member, i) => (
              <FloatingCard key={i} delay={0.3}>
                <div className="relative overflow-hidden rounded-2xl border-2 border-accent/30 bg-white p-8 shadow-premium transition-all duration-300 hover:border-accent hover:shadow-gold">
                  {/* Gold accent corner */}
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    ...
                    <div className="relative mb-6">
                      <div className="relative h-40 w-40 overflow-hidden rounded-full border-4 border-accent/20 shadow-lg transition-transform duration-300 hover:scale-105">
                        <Image
                          src={member.image}
                          alt={member.name}
                          fill
                      ...
                      {/* Gold ring accent */}
                      <div className="absolute -bottom-2 -right-2 flex h-12 w-12 items-center justify-center rounded-full border-2 border-accent bg-accent/10 shadow-md">
                    ...
                    >
                      <svg className="h-4 w-4 sm:h-5 sm:w-5 transition-transform group-hover:scale-110 shrink-0" fill="currentColor" viewBox="0 0 24 24">
