  ...
  theme: {
    extend: {
      colors: {
        ...
        accent: "rgb(216 176 74 / <alpha-value>)", // #d8b04a Gold (latest as requested)
        base: "rgb(255 255 255 / <alpha-value>)", // #FFFFFF Pure White
        text: "rgb(31 41 55 / <alpha-value>)", // #1F2937 Charcoal
        "pale-silver": "rgb(232 233 236 / <alpha-value>)", // #E8E9EC Pale silver
      },
      fontFamily: {
        ibm: [
          "var(--font-ibm)",
      ...
      backgroundImage: {
        "royal-gradient":
          "linear-gradient(135deg, rgb(11 70 52) 0%, rgb(15 95 70) 100%)",
        "gold-shimmer":
          "linear-gradient(90deg, transparent, rgba(216, 176, 74, 0.3), transparent)", // Updated gold color
        "premium-card":
          "linear-gradient(180deg, rgb(255 255 255) 0%, rgb(248 250 252) 100%)",
      },
      boxShadow: {
        royal: "0 10px 40px -10px rgba(11, 70, 52, 0.25)",
        gold: "0 0 20px rgba(216, 176, 74, 0.4)", // Updated gold color
        premium:
